...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <header className="bg-gradient-to-r from-blue-500 to-blue-600 text-white py-6 px-8 rounded-lg shadow-md mb-8">
      ...
      {alerts.length > 0 && (
        <div className="mt-12 bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-md" role="alert">
          <h3 className="font-bold text-lg mb-2">Weather Alerts</h3>
